  ...
  <div className="max-w-6xl mx-auto px-4">
    ...
    <div className="text-center mb-10">
      ...
      <p className="text-lg text-gray-600">
        Professional carpet cleaning at transparent rates
      </p>
    </div>
      ...
      <table className="w-full border-collapse">
        ...
        <tbody>
          {[
            ["Bedroom", "$35"],
            ["Study", "$25"],
            ["Living room (16-20 sq.m.)", "$50"],
            ["Through lounge (31-35 sq.m.)", "$70"],
            ["Flight of stairs", "$45"],
            ["Hallway", "$25"],
            ...
            >
              <td className="py-4 px-6 border-b border-gray-200">{area}</td>
