  ...
  return (
    <div>
      ...
      <section className="relative h-[300px] md:h-[400px] w-full">
        <img src={commercialImg} alt="Commercial Cleaning" className="w-full h-full object-cover object-center" />
        <div className="absolute inset-0 bg-black/40 flex flex-col justify-center">
          <div className="max-w-7xl mx-auto px-4 w-full">
            <h1 className="text-white text-3xl md:text-5xl font-bold mb-2">Professional Commercial Spaces Cleaning</h1>
